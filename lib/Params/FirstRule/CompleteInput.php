 ...
 * Used for testing
 */
class CompleteInput implements FirstRule
{
...
//    public function process(string $name, Input $varMap) : ValidationResult
    public function process(string $name, VarMap $varMap) : ValidationResult
    {
