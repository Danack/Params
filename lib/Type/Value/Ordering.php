...
class Ordering
{
    ...
    /** @var \Type\Value\OrderElement[] */
    private array $orderElements;

    /**
     * Order constructor.
     * @param \Type\Value\OrderElement[] $orderElements
     */
    ...
    /**
     * @return \Type\Value\OrderElement[]
     */
     ...
     */
    private static function reduce(array $carry, \Type\Value\OrderElement $orderElement)
    {
